                                ...
                                <div class=" -m-2">
                                    ...
                                    <div class="p-2 w-full">
                                        <div class="relative">
                                            ...
                                            <input type="radio" id="gender" name="gender" value="0" disabled
                                                @if ($gender === '男性') checked @endif class="mr-2 ml-2">男性
                                            <input type="radio" id="gender" name="gender" value="1" disabled
                                    ...
                                    <div class="p-2 w-full">
                                        <button onclick="location.href='{{ route('contacts.index') }}'"
                                            class="flex mx-auto text-white bg-green-500 border-0 py-2 px-8 focus:outline-none hover:bg-green-600 rounded text-lg">戻る</button>
                                    </div>
                                    {{-- 削除ボタン --}}
                                    <form method="post"
                                        ...
                                        @csrf
                                        <div class="p-2 w-full">
                                            <button type="button" deta-id ="{{ $contact->id }}"
